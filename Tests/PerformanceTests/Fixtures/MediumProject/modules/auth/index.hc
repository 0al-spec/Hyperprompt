...
This module handles auth index functionality.
...
```swift
// Example implementation for auth
struct AuthHandler {
...
- [Database index](../database/index.hc)
- [Api core](../api/core.hc)
- [Cache utils](../cache/utils.hc)
- [Queue types](../queue/types.hc)
- [Storage impl](../storage/impl.hc)
