...
This module handles config types functionality.
...
```swift
// Example implementation for config
...
- [Logging index](../logging/index.hc)
- [Metrics core](../metrics/core.hc)
- [Workers utils](../workers/utils.hc)
- [Auth types](../auth/types.hc)
- [Database impl](../database/impl.hc)
