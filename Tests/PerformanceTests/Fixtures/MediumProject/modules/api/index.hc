...
This module handles api index functionality.
...
```swift
// Example implementation for api
struct ApiHandler {
...
- [Cache index](../cache/index.hc)
- [Queue core](../queue/core.hc)
- [Storage utils](../storage/utils.hc)
- [Config types](../config/types.hc)
- [Logging impl](../logging/impl.hc)
