...
class MockFileSystem: FileSystem {
    ...
    ///
    /// Returns basenames of files that start with the given directory path.
    ...
    ///
    /// Returns true if any file path starts with this path as a directory prefix.
    ...
    ///
    /// Returns attributes based on in-memory file content.
