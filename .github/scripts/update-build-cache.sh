...
echo "  1. Upload ${CACHE_DIR}/${CACHE_NAME}.tar.gz to a shared location for team access"
echo "  2. Or store it in CI/CD artifacts or external object storage"
echo "  3. Do not commit build cache archives or track them with Git LFS"
