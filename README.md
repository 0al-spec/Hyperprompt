...
- **[USAGE.md](DOCS/USAGE.md)** — Complete CLI reference with all flags and options
- **[LANGUAGE.md](DOCS/LANGUAGE.md)** — Hypercode grammar specification and syntax rules
- **[ARCHITECTURE.md](DOCS/ARCHITECTURE.md)** — System design, module overview, data flow
...
For detailed solutions, see [ERROR_CODES.md](DOCS/ERROR_CODES.md).
...
For complete syntax specification, see [LANGUAGE.md](DOCS/LANGUAGE.md).
...
See [SPECS_INTEGRATION.md](DOCS/SPECS_INTEGRATION.md) for implementation details.
...
For detailed contribution guidelines, see [DOCS/FUTURE.md](DOCS/FUTURE.md).
