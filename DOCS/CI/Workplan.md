...
| CI-08 | Document CI usage, variables, and extension guidance in `DOCS/CI/README.md` or existing doc | High | 0.5h | CI-02–CI-07 | Dev **INPROGRESS** | Documentation explains workflow structure and customization | 
