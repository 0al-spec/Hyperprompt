...
| CI-07 | Set permissions block and secrets handling (least privilege; fail fast on missing secrets) | High | 0.5h | CI-02 | Dev **INPROGRESS** | Permissions minimized; no implicit write scopes | 
