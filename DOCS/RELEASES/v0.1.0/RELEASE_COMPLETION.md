...
**Location:** `DOCS/RELEASES/v0.1.0/test-results/`
...
**Location:** `DOCS/RELEASES/v0.1.0/benchmarks/`
...
**Location:** `DOCS/RELEASES/v0.1.0/hyperprompt-0.1.0-linux-x86_64.zip`
...
- Added ZIP archive to DOCS/RELEASES/v0.1.0/
...
| **ZIP archive** | `DOCS/RELEASES/v0.1.0/*.zip` | 5.6 MB | ✅ Created |
| **CHANGELOG** | `CHANGELOG.md` | 6 KB | ✅ Created |
| **Release notes** | `DOCS/RELEASES/v0.1.0/RELEASE_NOTES_v0.1.0.md` | 16 KB | ✅ Created |
| **Test results** | `DOCS/RELEASES/v0.1.0/test-results/` | 6 KB | ✅ Archived |
| **Benchmarks** | `DOCS/RELEASES/v0.1.0/benchmarks/` | 12 KB | ✅ Archived |
